        ...
        <div className="eventss">
          ...
          <div className="eventDes">
            ...
            <p className="aboutpara">
              ...
              skills. Gather your team, bring your A-game, and prepare to
              compete against the brightest minds. Only those with the sharpest
              wit and quickest reflexes will emerge victorious in the Brainly
              Bowl Quiz. Are you ready to prove your mental mettle?
            </p>
            ...
            <div className="aboutpara">
              <ul>
                <li>
                  Note: questions based on aptitude, logical, generalized
                  questions
                </li>
              ...
              <ul>
                ...
                <li>
                  Disclaimer: If any team is noticed with malpractice, they will
                  be eliminated
                </li>
              </ul>
            </div>
