...
<div className="eventss">
        ...
        <div className="eventDes">
         ...
         <div className="aboutpara">
            <ul>
                <li>Topic Selection: Choose a relevant topic within the given theme</li>
                ...
                <li>Language: Present in a language understandable to the audience.</li>
                <li>Prizes: Prizes or certificates may be awarded to the best presentations.</li>
            </ul>
         </div>
        <Link to={"/register"}>  <div className="learnMore">
                Register
            </div></Link>
        </div>
